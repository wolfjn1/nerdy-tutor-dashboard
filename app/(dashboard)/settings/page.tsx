...
export default function SettingsPage() {
  ...
  const renderPrivacySection = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Control who can see your profile and information</p>
      </div>
        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 cursor-pointer">
              ...
              />
              <div className="ml-3">
                <div className="font-medium text-gray-900">Students Only</div>
                <div className="text-sm text-gray-500">Only your students can view your full profile</div>
              </div>
            </label>
          </div>
        </div>
  ...
  const renderPreferencesSection = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Platform Preferences</h3>
        <p className="text-sm text-gray-500">Customize your experience on the platform</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 border border-gray-200 rounded-lg">
          <div className="flex items-center justify-between mb-3">
            ...
            <Badge variant="secondary" className="bg-yellow-50 text-yellow-700 border-yellow-200" animate={false}>
              Not Enabled
            </Badge>
          </div>
        ...
        <div className="p-4 border border-gray-200 rounded-lg">
          <h4 className="font-medium text-gray-900 mb-2">Login Activity</h4>
          <div className="space-y-2 text-sm">
            <div className="flex items-center justify-between py-2 border-b border-gray-100">
              <div>
                <div className="text-gray-900">Chrome on Mac</div>
                <div className="text-gray-500">San Francisco, CA</div>
              </div>
              <div className="text-gray-500">Current session</div>
            </div>
            <div className="flex items-center justify-between py-2">
              <div>
                <div className="text-gray-900">Safari on iPhone</div>
                <div className="text-gray-500">San Francisco, CA</div>
              </div>
  ...
  const renderBillingSection = () => (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-1">Billing & Payment</h3>
      ...
      <div className="space-y-4">
        <div className="p-4 border border-gray-200 rounded-lg">
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-gray-900">Bank Account ****4567</div>
        ...
        <div className="p-4 border border-gray-200 rounded-lg">
          ...
          <p className="text-sm text-gray-500 mb-3">Keep your tax information up to date for accurate reporting</p>
          <Button variant="outline" size="sm" className="w-full">
            Update Tax Info
          </Button>
        </div>
  ...
  const renderAccountSection = () => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Manage your account settings and data</p>
      </div>
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <div className="mb-6" style={{ opacity: '1 !important', transform: 'none !important' }}>
