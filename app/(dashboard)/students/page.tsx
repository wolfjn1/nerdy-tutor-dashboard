...
export default function StudentsPage() {
  ...
  const filteredStudents = useMemo(() => {
    ...
    return filtered
  }, [studentsWithStats, searchTerm, selectedSubject, selectedGrade, sortBy])
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <Button variant="gradient" gradientType="nerdy" leftIcon={<Plus className="h-4 w-4" />}>
              Add Student
            </Button>
          </div>
        </motion.div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">
                    {Math.round(students.reduce((sum, s) => sum + s.progress.performance, 0) / students.length)}%
                  </div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0">
            <div className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">
                    {studentsWithStats.filter(s => s.stats.nextSession).length}
                  </div>
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0">
            <div className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">
                    {Math.round(studentsWithStats.reduce((sum, s) => sum + s.stats.avgRating, 0) / studentsWithStats.length * 10) / 10}
                  </div>
